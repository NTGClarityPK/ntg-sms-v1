...
|----------|-------|-----|----------|
| id-cards | BE service | backend/src/modules/id-cards/card-data.service.ts → IdCardPdfService | — |
| id-cards | BE service | backend/src/modules/id-cards/id-cards.service.ts → IdCardPdfService | — |
