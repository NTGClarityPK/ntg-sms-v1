...
const testimonials = [
  {
    quote: 'Reduced order errors by 90%',
    content:
      'Before NTG Resto, we had constant mistakes with paper tickets. Now everything is perfect.',
    name: 'Ahmed',
    role: 'Restaurant Owner',
    restaurantType: 'of a fast food chain with 14 branches',
  },
  {
    quote: 'Cut food waste in half',
    content:
      'The inventory alerts helped us reduce waste from 20% to under 10%.',
    name: 'Sara',
    role: 'Cafe Manager',
    restaurantType: 'of a specialty coffee chain',
  },
  {
    quote: 'Doubled our speed during rush hours',
    content:
      'We serve twice as many customers in the same time. The POS is incredibly fast.',
    name: 'Omar',
    role: 'Fast Food Chain Owner',
    restaurantType: 'of a multi-location restaurant group',
  },
];
