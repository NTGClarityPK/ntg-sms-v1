        ...
        <Stack gap="md" style={{ flex: 1, position: 'relative' }}>
          ...
          <Stack gap="xs" mt="md">
            <Group justify="space-between">
              <Text size="sm" style={{ color: marketingColors.textSecondary }}>Locations:</Text>
              <Text size="sm" fw={600} style={{ color: marketingColors.textPrimary }}>{plan.locations}</Text>
            </Group>
            <Group justify="space-between">
              <Text size="sm" style={{ color: marketingColors.textSecondary }}>Users:</Text>
              <Text size="sm" fw={600} style={{ color: marketingColors.textPrimary }}>{plan.users}</Text>
            </Group>
            <Group justify="space-between">
              <Text size="sm" style={{ color: marketingColors.textSecondary }}>Menu Items:</Text>
              <Text size="sm" fw={600} style={{ color: marketingColors.textPrimary }}>{plan.menuItems}</Text>
            </Group>
            <Group justify="space-between">
              <Text size="sm" style={{ color: marketingColors.textSecondary }}>Orders/Month:</Text>
              <Text size="sm" fw={600} style={{ color: marketingColors.textPrimary }}>{plan.ordersMonth}</Text>
            </Group>
          </Stack>
