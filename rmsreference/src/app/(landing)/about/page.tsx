...
const values = [
  {
    icon: IconTarget,
    title: 'Our Mission',
    description: 'To empower restaurants worldwide with cutting-edge technology that simplifies operations and drives growth.',
  },
  {
    icon: IconUsers,
    title: 'Our Team',
    description: 'A dedicated group of developers, designers, and restaurant industry experts working together to create the best POS solution.',
  },
  {
  ...
  },
  {
    icon: IconRocket,
    title: 'Our Vision',
    description: 'To become the leading restaurant management platform globally, helping thousands of restaurants thrive.',
  },
];
    ...
    <>
      ...
      <main style={{ paddingTop: '80px' }}>
          ...
          <Container size="xl" pt={{ base: 'xl', md: 100 }} pb={{ base: 'xl', md: 40 }} style={{ position: 'relative', zIndex: 1 }}>
            <Stack gap="xl" align="center">
              ...
              >
                ...
                >
                  We&apos;re building the future of restaurant management, one feature at a time. Born from a deep understanding of the restaurant industry.
                </Text>
              </motion.div>
            </Stack>
          </Container>
            ...
            >
              <Stack gap="lg">
                ...
                <Text size="lg" style={{ color: marketingColors.textSecondary, lineHeight: 1.8 }}>
                  NTG Resto was founded with a simple mission: to make restaurant management effortless. After years of working with restaurants worldwide, we noticed a common challenge - existing POS systems were either too complex, too expensive, or didn&apos;t understand the unique needs of modern restaurants.
                </Text>
                <Text size="lg" style={{ color: marketingColors.textSecondary, lineHeight: 1.8 }}>
                  We set out to build a solution that combines powerful features with intuitive design, flexible payment methods, multi-language support, and everything else restaurants need to succeed. Today, we&apos;re proud to serve restaurants of all sizes, from small cafes to large chains, helping them streamline operations and grow their business.
                </Text>
              </Stack>
            </Card>
          </Container>
        ...
        <PageCTASection
          ...
          description="Let's work together to transform your restaurant operations"
