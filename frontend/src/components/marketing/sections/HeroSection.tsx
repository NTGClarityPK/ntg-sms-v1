      ...
      <Container size="xl" py={{ base: 'xl', md: 80 }} style={{ position: 'relative', zIndex: 1 }}>
        <Stack gap="xl" align="center" ta="center">
          ...
          >
            ...
            >
              Complete cloud-based school management: attendance, timetables, assessments,
              parent communication, and multi-branch reporting.
            </Text>
          </motion.div>
        ...
        <ImageLightbox src="/SMSUI.png" alt="NTG Alma dashboard demo">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
